...
const MobileScience = () => {
  return (
    <>
      ...
      {/* Second Section */}
      <div className="container-fluid mt-5 py-4" style={{ backgroundColor: '#3b3b48', color: 'white' }}>
        <div className="container">
          <div className="row">
            <div className="col-12">
              ...
              <p className="paragraph-element" style={{color:'red', fontWeight:'600'}}>Note: As it is conceptualized and designed by us, more features can be added as per the requirement.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-md-12">
          <div className="row">
            <div className="col-6 col-md-6 mb-3">
              <img src={MobileScienceImg2} alt="Image 1" className="img-fluid rounded w-100" />
            </div>
            <div className="col-6 col-md-6 mb-3">
              <img src={MobileScienceImg4} alt="Image 3" className="img-fluid rounded w-100" />
            </div>
            <div className="col-6 col-md-6 mb-3">
              <img src={MobileScienceImg3} alt="Image 2" className="img-fluid rounded w-100" />
            </div>
           
            <div className="col-6 col-md-6 mb-3">
              <img src={MobileScienceImg5} alt="Image 4" className="img-fluid rounded w-100" />
            </div>
          </div>
        </div>
      </div>
