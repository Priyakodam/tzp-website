...
import image3 from '../../Images/catedu3.jpg'
      ...
      <div className="kstep-row d-flex align-items-center">
        <div className="kstep-col-md-6">
          <p className='kstep-paragraph-element'>
            For India to become the biggest economy in the world by 2047, much has to happen across the different sectors.
            At the core of this transformation, however, is the synergy between agricultural innovation and rural education empowerment.
          </p>

          <p className='kstep-paragraph-element mt-4'>
            The agriculture sector, engaging almost half of India’s workforce, has huge potential. It will help the farmer ensure
            the best yield for his crop without leading to any losses/wastages if practiced using precision farming methods.
            Proceeding with data-driven decisions, AI and IoT in agriculture will alter the age-old practice of cultivation.
            Promotion of sustainable agriculture and organic farming will not only bring in more exports but also provide
            food security for the burgeoning population.
          </p>
        </div>
        <div className="kstep-col-md-6 d-flex justify-content-center">
          <img src={image3} alt="Card 3" className="kstep-img " />
        </div>
      </div>
