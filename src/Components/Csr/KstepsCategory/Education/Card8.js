...
const Card8 = () => {
  return (
    <div className="container mt-4">
      ...
      <section className="mt-4">
        <h5>The Importance of Hands-On Science Education</h5>
        <p>
      ...
      <section className="mt-4">
        <h5>Tare Zameen Par's Approach to Hands-On Science</h5>
        <p>
      ...
      <section className="mt-4">
        <h5>Engaging Students with Science Kits</h5>
        <ul>
          <li>
      ...
      <section className="mt-4">
        <h5>Case Study: Transforming Science Education with Hands-On Learning</h5>
        <p>
