...
const Card8 = () => {
  return (
    <div className="container mt-4">
      ...
      <section className="mt-4">
        <h5 className='Sub-Heading'>The Importance of Hands-On Science Education</h5>
        <p className='paragraph-element'>
      ...
      <section className="mt-4">
        <h5 className='Sub-Heading'>Tare Zameen Par's Approach to Hands-On Science</h5>
        <p className='paragraph-element'>
      ...
      <section className="mt-4">
        <h5 className='Sub-Heading'>Engaging Students with Science Kits</h5>
        <ul>
          <li>
      ...
      <section className="mt-4">
        <h5 className='Sub-Heading'>Case Study: Transforming Science Education with Hands-On Learning</h5>
        <p className='paragraph-element'>
