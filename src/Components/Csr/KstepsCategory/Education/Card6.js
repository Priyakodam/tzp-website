      ...
      <div className="kstep-row d-flex align-items-center">
        <div className="kstep-col-md-6">
          <p className='kstep-paragraph-element'>
            Development in rural education is crucial, as highlighted by personal experiences of individuals from villages.
            Growing up in a small village, the lack of access to the latest knowledge updates compared to urban areas was a common challenge.
            Visits to cities like Thane, Pune, and Dombivli exposed them to modern amenities such as television channels showcasing
            new cartoons, music, and movies, which were not available in their village. This disparity in exposure created a feeling
            of inadequacy and demotivation, hindering their confidence and communication skills in social settings.
          </p>
        </div>
        <div className="kstep-col-md-6 d-flex justify-content-center">
          <img src={image4} alt="Card 4" className="kstep-img " />
        </div>
      </div>
